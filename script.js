  ...
  if (fbSection && fbWrap) {
    ...
    if (activeBanners.length) {
      ...
      fbWrap.innerHTML = titleHtml + activeBanners.map((banner, idx) => {
        ...
        return `
          <div class="featured-banner-item" style="${idx < activeBanners.length - 1 ? 'padding-bottom:120px;margin-bottom:120px;border-bottom:1px solid rgba(255,255,255,0.06);' : ''}">
